    ...
    public class AuthenticateService : IAuthenticateService
    {
        ...
        public SessionInfo GetSessionInfo(string sessionToken)
        {
            ...
            if (sessionInfo == null)
            {
                ...
                SampleServiceDbContext context = scope.ServiceProvider.GetRequiredService<SampleServiceDbContext>();
        ...
        private Account FindAccountByLogin(SampleServiceDbContext context, string login)
        {
            return context
                .Accounts
